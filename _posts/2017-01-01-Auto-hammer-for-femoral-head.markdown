...
Measurement of airflow, pressure, and sound inside the model of miniature airway tree
...
![Bell crank mechanism](/img/neeww/bell-crank-mechanism.png)
Velocity profile measurement using hot wire at different vertical distance from the edge of the tube.
...
![Robotic arm - exploded view](/img/asdasd/robotic-arm.png)
Calibration of probe microphone (Left): Probe microphone is connected to the calibration port of the signal conditioner unit. (Right): Microphone output is plotted in an oscilloscope.

![Electrical Circuit](/img/app/electrical-circuit.png)
Figure 9: Probe microphone is placed at a distance of 80 mm (Left) and 40 mm (Right) from the speaker
...
![Electrical Circuit](/img/asd/electrical-circuit.png)
Figure: The miniature pig airway tree
...
![Electrical Circuit](/img/asd/electrical-circuit.png)
Figure 6: Pressure loss at normal (left) and constricted(right) airways
